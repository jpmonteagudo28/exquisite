...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/exquisite)](https://CRAN.R-project.org/package=exquisite)
...
You can install the development version of exquisite from [GitHub](https://github.com/) with:
